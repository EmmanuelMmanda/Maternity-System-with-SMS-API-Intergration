<?php include 'includes/database.php';session_start(); ?>
<?php
if(isset($_POST['login'])){
        $uname = mysqli_real_escape_string($conn,$_POST['username']);
        $pass = mysqli_real_escape_string($conn,$_POST['password']);
        $password = md5($pass);
        $sql = "SELECT * FROM `medical_officer` WHERE `username`='$uname' AND `password`='$password'";
...
<head>
    <title>Administrator | Login Now</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
        ...
        <div class="container mt-5">
            <div class="m-auto col-4 mx-5 bg-light rounded p-3 ">
                <form action="" method="post">
                    ...
                    <div class="form-group text-center text-danger p-1">
                        <h4>Medical Officer -Login</h4>
                    </div>
